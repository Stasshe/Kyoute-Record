...
import { Check, Key, LogIn, LogOut, Menu, User as UserIcon, X } from 'lucide-react';
...
export default function AuthControls({ user, setUser, setRows }: Props) {
  ...
  return (
    <div className="flex items-center gap-3 text-sm relative">
      ...
      <button
        className="md:hidden flex items-center px-2 py-1 border rounded bg-white"
      ...
      <div className="hidden md:flex items-center gap-3">
        {user ? (
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={signUpWithEmail} className="text-sm px-3 py-1 border rounded">
              登録
            </button>
          </div>
        )}
      ...
      {/* Mobile panel */}
      {showMobileMenu && (
        <div className="md:hidden absolute right-0 top-12 bg-white border rounded p-3 shadow-md w-64 z-40">
          {user ? (
            <div className="space-y-3">
              <div className="flex items-center gap-2 px-2 py-1 border rounded bg-gray-50">
                <UserIcon size={16} className="text-gray-600" />
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 text-sm px-3 py-2 border rounded"
              >
                <Key size={14} /> パスワード変更
              </button>
              <button
                ...
                className="w-full flex items-center justify-center gap-2 text-sm px-3 py-2 border rounded bg-gray-50"
              >
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex-1 flex items-center justify-center gap-2 text-sm px-3 py-2 bg-black text-white rounded"
                    >
                      <Check size={14} /> 変更
                    </button>
                    <button
                      ...
                      className="flex-1 flex items-center justify-center gap-2 text-sm px-3 py-2 border rounded"
                    >
                      <X size={14} /> キャンセル
                    </button>
                  </div>
            ...
            <div className="space-y-2">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 text-sm px-3 py-2 bg-black text-white rounded"
              >
                <LogIn size={14} /> ログイン
              </button>
              <button
